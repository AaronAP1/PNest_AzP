...
export class EvaluacionPracticanteController {
  ...
  @Get()
  @ApiOperation({ summary: 'Listar todas las evaluaciones de practicante' })
  @ApiResponse({ status: 200, description: 'Lista obtenida exitosamente' })
  findAll(): Observable<any> {
    return this.httpService
      .get(`${this.evaluacionesServiceUrl}/evaluacion-practicante`)
      .pipe(map((response) => response.data));
  }
  ...
  findOne(@Param('id') id: string): Observable<any> {
    return this.httpService
      .get(`${this.evaluacionesServiceUrl}/evaluacion-practicante/${id}`)
      .pipe(map((response) => response.data));
  }
  ...
  findBySolicitud(@Param('idSolicitud') idSolicitud: string): Observable<any> {
    return this.httpService
      .get(`${this.evaluacionesServiceUrl}/evaluacion-practicante/solicitud/${idSolicitud}`)
      .pipe(map((response) => response.data));
  }
  ...
  update(@Param('id') id: string, @Body() updateDto: any): Observable<any> {
    return this.httpService
      .patch(`${this.evaluacionesServiceUrl}/evaluacion-practicante/${id}`, updateDto)
      .pipe(map((response) => response.data));
  }
  ...
  remove(@Param('id') id: string): Observable<any> {
    return this.httpService
      .delete(`${this.evaluacionesServiceUrl}/evaluacion-practicante/${id}`)
      .pipe(map((response) => response.data));
  }
}
